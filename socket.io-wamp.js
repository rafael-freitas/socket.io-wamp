    ...
    var _export_socket_wamp = function (io) {
        ...
        function create_wamp_interface(socket) {
            ...
            */
            ...
            function is_registred(route_name) {
                return rpc_pool.hasOwnProperty(route_name);
            }
             ...
             * @return {Promise}
             */
            socket.constructor.prototype.register = function register(route_name, fn) {

                var dfd = q.defer();

                socket.emit("wamp_register", route_name, function _wamp_register_callback(response) {
             ...
             * @return {Promise}
             */
            socket.constructor.prototype.call = function register(route_name, args) {
                var args = Array.prototype.slice.call(arguments);
                args.shift();

                var dfd = q.defer();

                socket.emit("wamp_call", {procedure: route_name, args: args}, function _wamp_call_callback(pack) {
            ...
            */
            ...
            function register_subscriber(topic, client, callback) {
                ...
                pubsub_pool[route_name].callbacks.push(callback);
                // pubsub_pool[route_name].clients.push(client);
            }
             ...
             * @return {Promise}
             */
            socket.constructor.prototype.publish = function publish(topic, args) {
                var args = Array.prototype.slice.call(arguments);
                args.shift();
